...
source("uvoz/uvoz_st_splavov_sola.R", encoding = "UTF-8")
```

Uvozil sem podatke iz Eurostata ter iz OECD-ja v podatkovni obliki CSV, ter v želji po poznavanju tudi drugih podatkovnih oblik še iz spletne strani UNData v obliki XML, pri obdelavi katerih imam še nekaj težav (podatke bi sicer lahko pobral tudi v CSV obliki in bi bilo delo lažje). Začetna stanja podatkov v obliki CSV ter XML so dostopna v mapi podatki, v mapi uvoz pa so kode za oblikovanje tidy data za vse podatke v obliki CSV, ter pozneje tudi za podatke v obliki XML.
