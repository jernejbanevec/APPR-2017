...
Oblike tabel ter spremenljivke sem že povzel v mapi README. Sestavil sem pa tudi dve novi tabeli, ki sem ju uporabil pri vizualizaciji. Ti dve tabeli imata naslednjo obliko:
...
Pri tabeli "Povprečna REALNA neto letna plača za določeno državo (v dolarjih)" sem neto plačo delil z indeksom cen za tisto leto, kjer je indeks normiran glede na referenčno leto 2010 za določeno državo. Prikazuje torej spreminanje realne plače skozi leta za to določeno državo, neodvisno od drugih držav.
...
Pri napredni analizi sem se najbolj osredotočal na računanje korelacije ter pojasnjevanje odvisnosti natalitete in nominalnega števila splavov od povprečne realne letne plače. 
...
Dobil sem pozitivno korelacijo, kot sem nekako predpostavljal. Natančneje, dobil sem korelacijo 0.4767125. Korelacija je precej visoka in pojasnjuje, da višja realna letna plača tudi pripomore k odločitvi para za otroka.
...
Razpršene podatke sem aproksimiral z linerano premico. Naklon te premice sem izračunal na dva načina in obakrat dobil enako vrednost. Prvič sem poračunal s pomočjo statistične funkcije "lm" in dobil enako vrednost kot s pomočjo formule, v kateri je naklon premice enak  količniku med produktom korelacije in standardnega odklona plače, ter standardnega odklona natalitete.

Največjo korelacijo sem odkril pri Danski, kjer ta znaša kar 0.9423279, kar je zelo blizu vrednosti ena oziroma popolni korelaciji. To je dobro razvidno iz naslednjega grafa linearne aproksimacije.
...
Kot lahko opazimo ima graf regresijsko premico z negativnim koeficientom. Ena od možnih razlag za to, da se pari pri višji realni plači redkeje odločijo za otroka, je po mojem mnenju ta, da se Slovenci ob višji realni plači raje odločijo za kariero oziroma za trenutni zaslužek kot za družino.

SPLAVI

Pri analizi korelacije števila splavov in realne plače podatkov nisem potreboval preurejati, saj se umetni splav običajno izvede v prvih desetih tednih od spočetja otroka. Sem pa zato iz podatkov za izračun korelacije izvzel Poljsko, kjer so splavi še vedno v splošnem prepovedani, ter Portugalsko, kjer so splavi dovoljeni od leta 2007. Te podatke sem izvzel, saj bi bila pri Poljski korelacija blizu 0, na Portugalskem pa skok v številu splavov ne bi bil pojasnjen z realno plačo, kar bi slabo vplivalo na resnično oziroma "pravo" vrednost korelacije.  
Pri splavih sem pričakoval različno predznačeno korelacijo kot pri nataliteti, saj se za splav načeloma odloči par, ki finančno ni dovolj stabilen oziroma nima dovolj prihodkov, da bi financiral otroka in njegov razvoj. Negativno korelacijo med nominalnim številom splavov in povprečno realno letno plačo potrjuje tudi korelacija izračunana iz danih podatkov, ki znaša -0.3875067. 
...
Poleg statistične ugotovitev, da sta nataliteta in povprečna realna plača pozitivno korelirani ter da sta nominalno število splavov in realna plača negativno korelirani, sem ugotovil še veliko novih stvari. Tako sedaj vem, da so na Poljskem splavi še vedno prepovedani ter da so na Portugaljskem splavi dovoljeni od leta 2007.Zavedam pa se, da imam relativno malo podatkov (le 15 na državo). Prav tako niso vsi podatki odvisni le od realne plače, saj kot sem že prej omenil na primer pri Rusiji in drugih državah vzhodne Evrope število splavov upada zaradi spoznavanja različnih oblik kontracepcije ter pomembnosti le-te. 